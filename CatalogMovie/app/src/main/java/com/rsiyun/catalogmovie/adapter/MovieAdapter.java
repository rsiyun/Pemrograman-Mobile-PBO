package com.rsiyun.catalogmovie.adapter;
...
import com.rsiyun.catalogmovie.R;
import com.rsiyun.catalogmovie.activity.DetailMovieActivity;
import com.rsiyun.catalogmovie.model.Result;
    ...
    public MovieAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        viewHolder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                result.setOriginalTitle(resultList.get(position).getOriginalTitle());
                result.setOverview(resultList.get(position).getOverview());
                result.setPosterPath(resultList.get(position).getPosterPath());
